...
export function Sidebar() {
  ...
  return (
    <aside className="w-80 bg-slate-50 dark:bg-slate-950 border-r border-gray-200 dark:border-slate-800 flex flex-col h-full overflow-hidden transition-colors">
      {/* Provider List */}
      <div className="p-4 border-b border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900">
        <h2 className="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider mb-3">Available Resources</h2>
              ...
              <div className="grid grid-cols-1 gap-2">
                {provider.resources.map((resource) => (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 dark:text-slate-400 bg-gray-50 dark:bg-slate-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 rounded-md transition-colors border border-transparent hover:border-indigo-100 dark:hover:border-indigo-800 text-left w-full group"
                  >
      ...
      {/* Global Settings */}
      <div className="px-4 py-3 border-b border-gray-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm z-10">
        <button
          ...
          className={clsx(
            ...
            selectedResourceId === '__settings__'
              ? "bg-indigo-50 dark:bg-indigo-900/20 text-indigo-700 dark:text-indigo-400 border-indigo-200 dark:border-indigo-800 shadow-sm"
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-slate-50 dark:bg-slate-950">
        <h2 className="text-xs font-semibold text-gray-500 dark:text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-2">
              ...
              <div
                ...
                className={clsx(
                  ...
                  selectedResourceId === resource.id
                    ? "bg-white dark:bg-slate-900 border-indigo-200 dark:border-indigo-800 shadow-sm text-indigo-700 dark:text-indigo-400"
                    : "bg-transparent border-transparent hover:bg-gray-100 dark:hover:bg-slate-900/50 text-gray-700 dark:text-slate-400"
                )}
              >
